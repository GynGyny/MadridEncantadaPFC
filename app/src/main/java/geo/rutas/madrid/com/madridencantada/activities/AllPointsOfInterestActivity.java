...
public class AllPointsOfInterestActivity extends AppCompatActivity {
    ...
    public void crearLugares(){
        ...
        Lugar reinaSofia = new Lugar(getString(R.string.sofia),"Hospital", "Medium", "No lo sé",R.drawable.pq_museo_reina_sofia, 40.407969, -3.694804);
        Lugar bancoEspania = new Lugar(getString(R.string.banco),"Banco", "Monja", "A veces", R.drawable.pq_banco_de_espana, 40.418740, -3.694601);
        Lugar ayuntamiento = new Lugar(getString(R.string.ayuntamiento),"Palacio Comunicaciones", "Masacre", "Metro Banco España", R.drawable.pq_ayuntamiento_de_madrid, 40.418633, -3.692476);
        Lugar linares = new Lugar(getString(R.string.linares), "Casa de América", "Psicofonías", "Recoletos", R.drawable.pq_casa_de_america, 40.419947, -3.692248);
        Lugar ejercito = new Lugar(getString(R.string.ejercito), "Cuartel General del Ejército de Tierra", "Prim", "Recoletos", R.drawable.pq_cuartel_general_ejercito, 40.421081, -3.694592);
        Lugar chimeneas = new Lugar(getString(R.string.chimenea), "7 chimeneas", "chimeneas", "Recoletos", R.drawable.pq_casa_de_las_7_chimeneas, 40.4202, -3.69666);
        Lugar iglesia = new Lugar(getString(R.string.iglesia), "Iglesia de San José", "Baile", "Gran vía", R.drawable.pq_iglesia_de_san_jose, 40.419068, -3.696654);
        Lugar teatro = new Lugar(getString(R.string.teatro), "Teatro Español", "Muchos", "Plaza Santa Ana", R.drawable.pq_teatro_espanol_madrid, 40.414852, -3.699982);
        Lugar ana = new Lugar(getString(R.string.ana), "Plaza de Santa Ana", "No me acuerdo", "Plaza de Santa Ana", R.drawable.pq_plaza_de_santa_ana, 40.414714, -3.700897);
        ...
        Lugar cabeza = new Lugar(getString(R.string.cabeza), "Calle de La Cabeza", "Cabeza", "Calle de La Cabeza", R.drawable.pq_cabeza1, 40.411864, -3.703292);
        Lugar palacio = new Lugar(getString(R.string.palacio), "Palacio de Santa Cruz", "palacios", "palacio", R.drawable.pq_palacio_de_santa_cruz, 40.4147, -3.706031);
        Lugar mayor = new Lugar(getString(R.string.mayor), "Plaza Mayor", "Ajusticiados", "Plaza Mayor", R.drawable.pq_plaza_mayor, 40.415556, -3.707222);
